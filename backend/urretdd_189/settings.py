"""
Django settings for urretdd_189 project.
...
WSGI_APPLICATION = 'urretdd_189.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "urretdd_189 API",
    "DESCRIPTION": "API documentation for urretdd_189 App",
    "VERSION": "v1",
}
